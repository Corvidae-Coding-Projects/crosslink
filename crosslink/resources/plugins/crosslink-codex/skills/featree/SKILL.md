...
- Worktrees MUST be placed inside `<repo-root>/.worktrees/` so provider project configuration, hook trust checks, and Crosslink discovery resolve against the intended repository.
