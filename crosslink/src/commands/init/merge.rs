...
pub(super) const GITIGNORE_SECTION_START: &str = "/.crosslink-managed-section-start";
pub(super) const GITIGNORE_SECTION_END: &str = "/.crosslink-managed-section-end";
pub(super) const AGENTS_SECTION_START: &str = "## Crosslink-managed repository reference";
pub(super) const AGENTS_SECTION_END: &str = "## End Crosslink-managed repository reference";
const LEGACY_GITIGNORE_SECTION_START: &str =
    "# === Crosslink managed (do not edit between markers) ===";
const LEGACY_GITIGNORE_SECTION_END: &str = "# === End crosslink managed ===";
const LEGACY_AGENTS_SECTION_START: &str = "<!-- crosslink:managed:start -->";
const LEGACY_AGENTS_SECTION_END: &str = "<!-- crosslink:managed:end -->";
...
pub(super) fn write_root_gitignore(project_root: &Path) -> Result<()> {
    ...
    let existing = fs::read_to_string(&gitignore_path)
        .unwrap_or_default()
        .replace(LEGACY_GITIGNORE_SECTION_START, GITIGNORE_SECTION_START)
        .replace(LEGACY_GITIGNORE_SECTION_END, GITIGNORE_SECTION_END);
...
pub(super) fn write_agents_md_merged(agents_path: &Path) -> Result<()> {
    let existing = fs::read_to_string(agents_path)
        .unwrap_or_default()
        .replace(LEGACY_AGENTS_SECTION_START, AGENTS_SECTION_START)
        .replace(LEGACY_AGENTS_SECTION_END, AGENTS_SECTION_END);
