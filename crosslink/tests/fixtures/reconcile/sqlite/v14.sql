...
INSERT INTO issues (id, title, description, status, priority, parent_id, created_at, updated_at, closed_at, uuid, created_by) VALUES (1, 'fixture-v14', 'historical fixture', 'open', 'medium', NULL, '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z', NULL, '00000000-0000-0000-0000-000000000014', 'fixture-agent');

INSERT INTO labels (issue_id, label) VALUES (1, 'fixture');

INSERT INTO comments (id, issue_id, content, created_at, uuid, author, kind, trigger_type, intervention_context, driver_key_fingerprint) VALUES (1, 1, 'fixture comment', '2026-01-01T00:00:00Z', '10000000-0000-0000-0000-000000000014', 'fixture-agent', 'note', NULL, NULL, 'fixture-key');
...
INSERT INTO milestones (id, name, description, status, created_at, closed_at, uuid) VALUES (1, 'fixture milestone', 'historical fixture', 'open', '2026-01-01T00:00:00Z', NULL, '20000000-0000-0000-0000-000000000014');
