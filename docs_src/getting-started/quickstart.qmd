...
::: {.guide-card}
![](../assets/img/cards/quickstart.svg){.card-icon}
...
This creates `.crosslink/` (config, rules, database, shared hooks/MCP), Claude
settings and skills, and Codex hooks, config, skills, and managed `AGENTS.md`
guidance. Both integrations are installed by default; `agent.provider` selects
the runtime. See [Installation](installation.qmd) and
[Claude and Codex providers](../guides/providers.qmd).
...
- [Hooks Guide](../guides/hooks.qmd) — repository coordination and diagnostics
