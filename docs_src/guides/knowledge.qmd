...
crosslink issue search "auth" --from github.com/org/other-repo
```

External queries clone the target repo's coordination branches into a temporary cache. Results are clearly marked with the source repository. This is useful for:
