...
::: {.full-width-banner}
![](assets/img/banner.svg){.hero-banner}
:::
...
[View on GitHub](https://github.com/Corvidae-Coding-Projects/crosslink){.btn-secondary}
:::
...
### Container Agents
Run agents in isolated Docker containers for stronger sandboxing. The same repository hooks and coordination work cross-platform.
:::
...
### Works Everywhere
Native CLI + VS Code extension. First-class Claude Code and Codex providers, plus a custom-provider boundary and context integrations for other agents.
:::
