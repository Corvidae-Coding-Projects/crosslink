...
```json
{
  ...
  "agent": {
    ...
    "providers": {
      ...
      "codex": {"standard_model": null, "advanced_model": null, "sandbox": "workspace-write", "approval": "never"}
    }
  },
...
current default. Codex host sandbox defaults to `workspace-write`; container
execution may use danger-full-access only inside external isolation.
